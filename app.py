...
# Predefined tickers
ticker_options = {
    "Abbott India": {"symbol": "ABBOTINDIA.NS", "allocation": 2},
    "Amber Enterprises India Limited": {"symbol": "AMBER.NS", "allocation": 3.54},
    "Angel One Limited": {"symbol": "ANGELONE.NS", "allocation": 1.96},
    "Apar Industries Limited": {"symbol": "APARINDS.NS", "allocation": 3.21},
    "Ashok Leyland": {"symbol": "ASHOKLEY.NS", "allocation": 2},
    "Bajaj Finance": {"symbol": "BAJFINANCE.NS", "allocation": 3.20},
    "Bharat Dynamics Limited": {"symbol": "BDL.NS", "allocation": 2.78},
    "Bharat Electronics Limited": {"symbol": "BEL.NS", "allocation": 4.29},
    "CG Power and Industrial Solutions Limited": {"symbol": "CGPOWER.NS", "allocation": 3.97},
    "Cholamandalam Investment and Finance Company Ltd": {"symbol": "CHOLAFIN.NS", "allocation": 3.29},
    "Data Patterns": {"symbol": "DATAPATTNS.NS", "allocation": 2},
    "Deepak Fertilisers": {"symbol": "DEEPAKFERT.NS", "allocation": 2},
    "Dixon Technologies (India) Limited": {"symbol": "DIXON.NS", "allocation": 2.32},
    "Eicher Motors": {"symbol": "EICHERMOT.NS", "allocation": 2},
    "GE Vernova T&D India Limited": {"symbol": "GEVERNOVA.NS", "allocation": 3.12},
    "Godrej Industries": {"symbol": "GODREJIND.NS", "allocation": 2},
    "Gravita": {"symbol": "GRAVITA.NS", "allocation": 2},
    "Gujarat Fluorochemicals Limited": {"symbol": "GUJFLUORO.NS", "allocation": 2.19},
    "HDFC Bank": {"symbol": "HDFCBANK.NS", "allocation": 2},
    "Hindustan Aeronautics Limited": {"symbol": "HAL.NS", "allocation": 3.10},
    "Inox Wind Limited": {"symbol": "INOXWIND.NS", "allocation": 2.35},
    "Kaynes Technology India Limited": {"symbol": "KAYNES.NS", "allocation": 2.52},
    "Kalyan Jewellers India Limited": {"symbol": "KALYAN.NS", "allocation": 1.64},
    "K.P.R. Mill Limited": {"symbol": "KPRMILL.NS", "allocation": 0.84},
    "Kirloskar Engines": {"symbol": "KIRLOSENG.NS", "allocation": 2},
    "Larsen & Toubro": {"symbol": "LT.NS", "allocation": 2},
    "Max Healthcare": {"symbol": "MAXHEALTH.NS", "allocation": 2},
    "Muthoot Finance Limited": {"symbol": "MUTHOOTFIN.NS", "allocation": 2.38},
    "Multi Commodity Exchange of India Limited": {"symbol": "MCX.NS", "allocation": 3.45},
    "Motilal Oswal Midcap": {"symbol": "0P0001BAYU.BO", "allocation": 2},
    "NBCC": {"symbol": "NBCC.NS", "allocation": 2},
    "Neuland Labs": {"symbol": "NEULANDLAB.NS", "allocation": 2},
    "Narayana Hrudayalaya": {"symbol": "NH.NS", "allocation": 2},
    "Nifty BeES": {"symbol": "NIFTYBEES.NS", "allocation": 2},
    "Onesource Specialty Pharma Limited": {"symbol": "ONESOURCE.NS", "allocation": 2.99},
    "Parag Parikh Flexi Cap": {"symbol": "0P0000YWL0.BO", "allocation": 2},
    "PB Fintech Limited": {"symbol": "PBFINTECH.NS", "allocation": 1.96},
    "PayTM": {"symbol": "PAYTM.NS", "allocation": 3.43},
    "Premier Energies Limited": {"symbol": "PREMIER.NS", "allocation": 2.78},
    "Prestige Estates Projects Limited": {"symbol": "PRESTIGE.NS", "allocation": 3.16},
    "PTC Industries Limited": {"symbol": "PTCINDIA.NS", "allocation": 3.21},
    "Religare Enterprises Limited": {"symbol": "RELIGARE.NS", "allocation": 2.10},
    "Samvardhana Motherson International Limited": {"symbol": "MOTHERSON.NS", "allocation": 3.23},
    "Siemens Energy India Limited": {"symbol": "ENRIN.NS", "allocation": 3.71},
    "Suzlon Energy Limited": {"symbol": "SUZLON.NS", "allocation": 3.21},
    "Trent Limited": {"symbol": "TRENT.NS", "allocation": 2.63},
    "TVS Motor Company Limited": {"symbol": "TVSMOTOR.NS", "allocation": 0.54},
    "V2 Retail Limited": {"symbol": "V2RETAIL.NS", "allocation": 2.08},
    "Waaree Energies Limited": {"symbol": "WAAREEENER.NS", "allocation": 4.23},
    "Zen Technologies Limited": {"symbol": "ZENTEC.NS", "allocation": 2.43},
    "Zomato": {"symbol": "ETERNAL.NS", "allocation": 7.24}
}
