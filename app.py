...
ticker_options = {
    ...
    "Godrej Industries": {"symbol": "GODREJIND.NS", "allocation": .1},
    "Gravita": {"symbol": "GRAVITA.NS", "allocation": .1},
    ...
    "Kirloskar Engines": {"symbol": "KIRLOSENG.NS", "allocation": .1},
    "Larsen & Toubro": {"symbol": "LT.NS", "allocation": 2},
    "Max Healthcare": {"symbol": "MAXHEALTH.NS", "allocation": .4},
    ...
    "NBCC": {"symbol": "NBCC.NS", "allocation": .15},
    "Neuland Labs": {"symbol": "NEULANDLAB.NS", "allocation": .01},
    "Narayana Hrudayalaya": {"symbol": "NH.NS", "allocation": .25},
